...
namespace WorkersWages.API.Storage.Migrations
{
    ...
    [Migration("20220409181642_AddMimeTypeToFile")]
    partial class AddMimeTypeToFile
    {
            ...
            modelBuilder.Entity("WorkersWages.API.Storage.Models.Manufactory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 4, 9, 22, 16, 38, 844, DateTimeKind.Unspecified).AddTicks(5934), new TimeSpan(0, 4, 0, 0, 0)),
                            HeadFIO = "Пупкин Арсений Викторович",
                            Name = "Цех #1",
                            Number = "1",
                            Updated = new DateTimeOffset(new DateTime(2022, 4, 9, 22, 16, 38, 844, DateTimeKind.Unspecified).AddTicks(5934), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
