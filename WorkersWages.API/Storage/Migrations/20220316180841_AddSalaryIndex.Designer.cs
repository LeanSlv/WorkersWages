...
namespace WorkersWages.API.Storage.Migrations
{
    ...
    [Migration("20220316180841_AddSalaryIndex")]
    partial class AddSalaryIndex
    {
            ...
            modelBuilder.Entity("WorkersWages.API.Storage.Models.Manufactory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 3, 16, 22, 8, 38, 547, DateTimeKind.Unspecified).AddTicks(2900), new TimeSpan(0, 4, 0, 0, 0)),
                            HeadFIO = "Пупкин Арсений Викторович",
                            Name = "Цех #1",
                            Number = "1",
                            Updated = new DateTimeOffset(new DateTime(2022, 3, 16, 22, 8, 38, 547, DateTimeKind.Unspecified).AddTicks(2900), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
