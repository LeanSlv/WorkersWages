...
namespace WorkersWages.API.Storage.Migrations
{
    ...
    [Migration("20220310085525_AddLinksBetweenModels")]
    partial class AddLinksBetweenModels
    {
            ...
            modelBuilder.Entity("WorkersWages.API.Storage.Models.Manufactory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 3, 10, 12, 55, 19, 689, DateTimeKind.Unspecified).AddTicks(2726), new TimeSpan(0, 4, 0, 0, 0)),
                            HeadFIO = "Пупкин Арсений Викторович",
                            Name = "Цех #1",
                            Number = "1",
                            Updated = new DateTimeOffset(new DateTime(2022, 3, 10, 12, 55, 19, 689, DateTimeKind.Unspecified).AddTicks(2726), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
